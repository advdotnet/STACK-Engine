...
namespace ContentAnalyzer.Test
{
    ...
    public class ContentEnumeration
    {
        ...
        public void CreateContentTreeTest()
        {
            ...
            Assert.IsTrue(Result.Contains("public static string _path_ = \"Skins\\\\\";"));
            Assert.IsTrue(Result.Contains("public static string Default = \"Skins\\\\Default\";"));
            Assert.IsTrue(Result.Contains("public static string Normalmap = \"shaders\\\\Normalmap\";"));
            Assert.IsTrue(Result.Contains("public static string stacklogo = \"stacklogo\";"));
            Assert.IsTrue(Result.Contains("public static string stack = \"fonts\\\\stack\";"));
        }
    }
}
